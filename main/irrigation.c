...
typedef enum {USE_BLE,USE_WIFI,USE_LORA,MAIN_TASK,USE_ACS71020,MEASURE_POWER,MOTOR_CURRENT_PROT, TEMPSENSOR,CURRENTSENSOR,MEASURE_LEVEL,POWERMETER_TASK,HANDLE_SCHEDULED,CLONE_TASK,LAST_MODE} T_run_mode_bits;
...
int  PARAM_VALUES[pLAST-pRUN_MODE]={7,1,3,ACS71020_address_default,-1,1,0};
...
info: RUN_MODES:{USE_BLE,USE_WIFI,USE_LORA,MAIN_TASK,USE_ACS71020,MEASURE_POWER,MOTOR_CURRENT_PROT,TEMPSENSOR,CURRENTSENSOR,MEASURE_LEVEL,POWERMETER_TASK,HANDLE_SCHEDULED,CLONE_TASK}\n\
SLAVE_RELAY: switch slave relay ON/OFF\n\
FIRSTRUN: by set to 1 at next boot the run mode adjusted to default \n\
DUAL_MODE: {0:ONLY_SLAVE_RELAY| 1:CURR_PROTECTED| 2:VIA_LORA_FUNC| 3:CLONING}\n\
(default RUN_MODEs: 8191, 127)",
...
//8191: 0001 1111 1111 1111  master
//2607: 0000 1010 0010 1111  old slave
// 127: 0000 0000 0111 1111  slave
